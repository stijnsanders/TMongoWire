...
//
//                      Unit has been adjusted to accompany the TMongoWire
//                      library without causing collisions.
//
// -----------------------------------------------------------------------------------------------
...
function MongoMD5Hex(S: String): String;
...
begin
	...
	MD5Init(Context);
	MD5Update(Context, pChar(S), System.Length(S));
	MD5Final(Context, Digest);

	for I := 0 to 15 do Result := Result + Digits[(Digest[I] shr 4) and $0f] + Digits[Digest[I] and $0f];  
end;
